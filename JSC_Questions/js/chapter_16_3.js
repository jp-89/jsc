...
function chapter_16_3_Q_1_pic1(context, x1,y1){
	...
	// display angle
	displayName(context,centerO.x+30,centerO.y-2,"30");
...
function chapter_16_3_Q_5_pic1(context, x1,y1){
	...
	drawCircle( context,circle,"green");
	   ...
	   var circle_2 =  new Circle(centerO,30);	
	 drawCircle( context,circle_2,"purple");
	 displayName(context,centerO.x+15,centerO.y+2,"R");
