...
function Higher_Math_chapter_1_1_Q_26(context, x1,y1,x2,y2,x3,y3,x4,y4){
...
var font= "12px Arial";
context.fillStyle="blue";
displayName(context,x1+1,y1+20,"B = 60%");
...
var font= "12px Arial";
context.fillStyle="blue";
displayName(context,x2-60,y2+20,"S = 50%");
...
var font= "12px Arial";
context.fillStyle="blue";
displayName(context,x1+2,y1+160,"P = 50%");


var font= "14px Arial";
context.fillStyle="black";
displayNameWithFont(context,circle.centerX-70,circle.centerY-60,"10%",font);
displayNameWithFont(context,circle.centerX-10,circle.centerY-60,"20%",font);
displayNameWithFont(context,circle.centerX+40,circle.centerY-60,"10%",font);

displayNameWithFont(context,circle.centerX-45,circle.centerY-15,"20%",font);
displayNameWithFont(context,circle.centerX-10,circle.centerY-15,"10",font);
displayNameWithFont(context,circle.centerX+20,circle.centerY-15,"10%",font);

displayNameWithFont(context,circle.centerX-10,circle.centerY+40,"10%",font);
