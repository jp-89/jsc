...
function chapter_6_3_Q_3_4(context, x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,extension,increaseLength){
	var pointA =  new Point(x1,y1);
	var pointB =  new Point(x2,y2);
	var pointC =  new Point(x3,y3);
	var pointD =  new Point(x4,y4);
	var pointO =  new Point(x5,y5);
	...
	displayPointName(context,pointC,x3-25,y3+15);
	displayPointName(context,pointD,x4-15,y4+15);
	displayPointName(context,pointO,x5,y5+15);
	drawLineBetweenTwoPoints(context,pointA,pointB,"red");
	drawLineBetweenTwoPoints(context,pointC,pointO,"red");
	drawLineBetweenTwoPoints(context,pointD,pointO,"red");

}


function chapter_6_3_Q_5_pic1(context, x1,y1,x2,y2,x3,y3,extension,increaseLength){
	var pointA =  new Point(x1,y1);
	var pointB =  new Point(x2,y2);
	var pointC =  new Point(x3,y3);
	setPointName(pointA,"A");
